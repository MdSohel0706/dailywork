...
python manage.py sqlmigrate <appname> <indexofmigrationfile> 
    - to check the real sql queries used in a migration
...
------------------------
Every ModelAdmin class has a base queryset which we can override.
What we are doing is going to the base class and overriding the base queryset using the super() method.
eg. 
...
unit_price = models.DecimalField(
        max_digits=6, 
        decimal_places=2,
        validators = [MinValueValidator(0.01, message="Price of one unit cannot be less than 0.01")])
