...
'''list_1 = [43,73,12,23,45]
print("Before update the list :",list_1)
list_1.append(55)
print("After update the list :",list_1)'''

list_2 = [323,5564,5456,45646]
print("Before update :" ,list_2)
list_2.extend([323,554,5354])
print("After update the list :",list_2)
list_2.extend({'satish'})
list_2.extend({"apple","mango","cherrry"})
list_2.extend({"a","b"})
print("Enter the values :",list_2)
