...
class Student:
    ...
    def get_venkat(self):
        print("Enter the student details : ",self.id,self.name,self.email)

    def get_sam(self):
        print("Enter the student details : ",self.id,self.name,self.email)
satish = Student(101,"venkat","venkat143@gmail.com")
venkat = Student(102,"satish","satish143@gmail.com")
satish.get_venkat()
venkat.get_sam()
