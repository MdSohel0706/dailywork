...
# state
    ...
    def __init__(self,name,id,email,phone_number):
     ...
     #behaviour
    def name_get(self):
        print("Enter the student Details :" ,self.name,self.id,self.email,self.phone_number)

sam = Student("satish",101,"satish143@gmail.com","9556355365")
sam.name_get()
