...
print("Employee.__name__:", Employee.__name__)print("Employee.__doc__:", Employee.__doc__)
...
class Employee:
    '''This class give details about employee'''
    def __init__(self, eid, name, sal,email,phone_number):
        self.eid = eid
        self.name = name
        self.sal = sal
        self.email = email
    ...
    def get_data(self):
        print("Employee data : ", self.eid, self.name, self.sal,self.email,self.phone_number)
...
print("satish name :", getattr(satish, "name"))
print("satish eid  :", getattr(satish, "eid"))
print("satish email :", getattr(satish, "email"))
# print("satish addr  :", getattr(satish, "addr"))
...
print("Setting eid  :", setattr(satish, "eid", 200))
print("Setting addr :", setattr(satish, "address", 'Bangalore'))
print("Setting phone_number :", setattr(satish, "phone_number", "956737836"))

print("Get name:", getattr(satish, "name"))
print("Get eid :", getattr(satish, "eid"))
print("Get addr:", getattr(satish, "address"))
print("Get email:", getattr(satish, "email"))

print("Has attr sal :", hasattr(satish, "sal"))
print("Has attr addr:", hasattr(satish, "address"))
print("Has attr email:", hasattr(satish, "email"))
