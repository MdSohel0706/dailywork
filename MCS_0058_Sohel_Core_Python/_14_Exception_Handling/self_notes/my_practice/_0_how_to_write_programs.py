...
"""
# State  --> Variables
student_info = {12345: ['satish', '10th', 90, 'ATP'],
                43232: ['venkat', '10th', 85, 'CHR'],
                42422: ['pawan', '10th', 34, 'KRN']
                }
print("-----------------------")
# Behavior --> Functions
...
def find_length(in_list):
    try:
        ...
        pass
    print("length of list : ",find_length(list1))
print("Program Error ")
"""
"""list2 = ["satish","venkat","sam","pawan"]
def find_length(in_list):
    try:
        le = 0
        for each in list2:
        ...
        pass
print("length of list : ", find_length(list2))
print("Program Error ")
"""
